          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" size="sm" className="text-sm text-blue-600 hover:text-blue-700 hover:underline font-medium transition-colors">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative group">
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-slate-400">
                ...
                <Link to="/signup" className="font-bold text-blue-600 hover:text-blue-700 hover:underline transition-colors">
                  Apply for access
                </Link>
              </p>
            </div>
