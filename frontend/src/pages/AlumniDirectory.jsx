    ...
    useEffect(() => {
        const fetchAlumni = async () => {
            try {
                ...
                const defaultAlumni = [
                    { id: 'd1', initials: 'SJ', name: 'Sarah Johnson', title: 'Senior Software Engineer', company: 'Google', location: 'Mountain View, CA', year: 2018, isMentor: true, industry: 'Mentors', profile: { first_name: 'Sarah', last_name: 'Johnson', bio: 'Senior Engineer at Google.' }, alumni: { job_title: 'Senior Software Engineer', company: 'Google' }, email: 'sarah@google.com' },
                    { id: 'd2', initials: 'MC', name: 'Michael Chen', title: 'Product Manager', company: 'Microsoft', location: 'Seattle, WA', year: 2015, isMentor: true, industry: 'Mentors', profile: { first_name: 'Michael', last_name: 'Chen', bio: 'PM at Microsoft.' }, alumni: { job_title: 'Product Manager', company: 'Microsoft' }, email: 'michael@microsoft.com' },
                ];
